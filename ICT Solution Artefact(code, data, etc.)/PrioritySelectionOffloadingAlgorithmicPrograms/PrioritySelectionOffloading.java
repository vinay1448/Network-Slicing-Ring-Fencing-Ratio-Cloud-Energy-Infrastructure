...
public class PrioritySelectionOffloading {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String outputFilePath = "C:\\Users\\vinay\\Cloudsim_ResearchProject\\simulation_output_priorityselectionoffloadingalgorithmnewfive.txt";
            ...
            long startTime = System.nanoTime();  // Start timing the iteration
            ...
            // Write the total energy consumption results to the file
            ...
            long endTime = System.nanoTime();  // End timing the iteration
            long iterationTime = endTime - startTime;

            // Log the iteration and convergence time directly below energy consumption
            out.println("Iteration completed in " + (iterationTime / 1_000_000) + " ms.");
            out.println("Total convergence time: " + (iterationTime / 1_000_000) + " ms.");
    ...
    private static void simulateVMCommunication() {
    	 // Network Slice 1
        simulateCommunicationBetweenVMs(0, 1, 1);
        simulateCommunicationBetweenVMs(1, 0, 1);

        // Network Slice 2
        simulateCommunicationBetweenVMs(3, 5, 3); // Inter-ring
        simulateCommunicationBetweenVMs(3, 8, 3); // Inter-slice to Slice 3
        simulateCommunicationBetweenVMs(4, 8, 3); // Inter-slice to Slice 3
        simulateCommunicationBetweenVMs(4, 12, 3); // Inter-slice to Slice 3
        simulateCommunicationBetweenVMs(5, 6, 3); // Inter-ring
        simulateCommunicationBetweenVMs(5, 3, 3); // Inter-ring
        simulateCommunicationBetweenVMs(5, 12, 3); // Inter-slice to Slice 3
        simulateCommunicationBetweenVMs(6, 5, 3); // Inter-ring

        // Network Slice 3
        simulateCommunicationBetweenVMs(7, 11, 3); // Inter-ring
        simulateCommunicationBetweenVMs(8, 1, 3); // Inter-slice to Slice 1
        simulateCommunicationBetweenVMs(8, 3, 3); // Inter-slice to Slice 2
        simulateCommunicationBetweenVMs(8, 4, 3); // Inter-slice to Slice 2
        simulateCommunicationBetweenVMs(11, 7, 3); // Inter-ring
        simulateCommunicationBetweenVMs(12, 4, 3); // Inter-slice to Slice 2
        simulateCommunicationBetweenVMs(12, 5, 3); // Inter-slice to Slice 2
    }
    ...
    private static void simulatePrioritySelectionOffloading(DatacenterBroker broker) {
        for (Vm vm : vmList) {
            ...
            for (Cloudlet cloudlet : cloudletList) {
                ...
                // Add latency penalty based on the difference between execution time and transmission energy
                double latencyPenalty = 0.2222 * (localExecutionTime - transmissionEnergy / systemChannelGain);
                
                // Adjust energy with latency penalty
                localEnergyConsumption += latencyPenalty;

                // Compare local execution energy and offloading energy with binary decision
