...
public class AggregatedPrioritySelectionOffloading {
	  ...
	  private static List<Vm> vmList;
	    ...
	    public static void main(String[] args) {
	    	 ...
	    	 try {
	             ...
	             String outputFilePath = "C:\\Users\\vinay\\Cloudsim_ResearchProject\\simulation_output_aggregatedpriorityselectionoffloadingalgorithmnewfive.txt";
	             ...
	             out.println(datacenter3.getName() + " created.");
	             out.println(datacenter4.getName() + " created.");
