	package lambdafinalpriorityresearchprojectfinal;
	...
	public class FinalAggregatedPriorityLambda implements RequestHandler<Map<String, String>, String>  {
	   ...
	   @Override
	    public String handleRequest(Map<String, String> event, Context context) {
	        try {
	            ...
	            String outputFileKey = "simulation_output_aggregatedpriorityselectionoffloading.txt" + UUID.randomUUID() + ".txt";
	...
	// Step 3: Create Broker
	  ...
	  broker.submitCloudletList(cloudletList);
		             ...
		             // Step 5: Simulate VM-to-VM communication and offloading
	 ...
	 // End timing for the iteration
		             ...
		             long iterationTime = endTime - iterationStart;
		 ...
		 // Method to simulate idle energy consumption for isolated VMs
		    ...
		    private static void simulateCommunicationBetweenVMs(int vm1, int vm2, double bandwidth) {
		   	 Log.printLine("Simulating communication between VM " + vm1 + " and VM " + vm2 + " with bandwidth: " + bandwidth);
		   	    ...
		   	    // Calculate the energy consumption for the communication
