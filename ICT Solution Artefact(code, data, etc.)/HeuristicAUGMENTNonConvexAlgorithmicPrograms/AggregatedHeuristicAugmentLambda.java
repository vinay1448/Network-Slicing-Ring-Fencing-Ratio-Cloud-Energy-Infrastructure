package lambdafinalheuristicresearchprojectfinal;
...
public class AggregatedHeuristicAugmentLambda implements RequestHandler<Map<String, String>, String>  {
 ...
 @Override
    public String handleRequest(Map<String, String> event, Context context) {
        try {
            ...
            String outputFileKey = "simulation_output_aggregatedheuristicnonconvex.txt" + UUID.randomUUID() + ".txt";
 ...
 // Simulate communication with bandwidth, penalty, and energy costs
    ...
    private static double calculateOverallTaskCompletionTime(List<Cloudlet> cloudlets) {
        ...
        for (Cloudlet cloudlet : cloudlets) {
            ...
            double bandwidthPenalty = 0.1; // calculated penalty
