...
public class PreprocessedCSVScalable {
    ...
    public static void main(String[] args) {
        ...
        try {
            PrintStream out = new PrintStream(new FileOutputStream("C:\\Users\\vinay\\Cloudsim_ResearchProject\\simulation_output_aggregated.txt"));
            System.setOut(out);
            System.setErr(out);
            Log.setOutput(out);
            ...
            Log.printLine("Total Energy Consumption (including communication + idle + cloudlets): " + totalEnergy + " Watts");
            ...
            writeEnergyResultsToFile("C:\\Users\\vinay\\Cloudsim_ResearchProject\\simulation_output_aggregated.txt", totalEnergy, coolingPower, totalEnergyWithCooling, overallTaskCompletionTime);
            printCloudletList(newList);
            writeCloudletResultsToFile(newList, "C:\\Users\\vinay\\Cloudsim_ResearchProject\\simulation_output_aggregated.txt");
